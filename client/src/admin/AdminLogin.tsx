...
export default function AdminLogin() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      if (!supabase) throw new Error("Management login is not configured. Add the VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY variables to the Railway service and redeploy.");
