...
import { LEAVE_TYPES, leaveTypeLabel } from "@shared/leaveTypes";
...
export default function LeaveRequestPage() {
  ...
  const submit = trpc.leaveRequests.submit.useMutation({ onSuccess: () => { utils.leaveRequests.mine.invalidate(); setReason(""); setLeaveType("annual"); } });
