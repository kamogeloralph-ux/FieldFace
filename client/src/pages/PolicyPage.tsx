...
const sections = [
  ...
  ["Information collected", "The service may process employee numbers, names, tax numbers, contact details, password credentials, hourly rates, site assignments, clocking times, GPS coordinates, geofence results, selfie photographs, shift hours, payslips, deductions, and administrator audit records."],
  ...
  ["Access and security", "Management users are limited to their company’s operational data. Platform administrators can manage companies across the platform and must use that access only for authorized support and administration. Users must protect passwords, persistent-login devices, and administrator sessions."],
