...
export default function ClockScreen() {
  ...
  if (me.isLoading || status.isLoading) {
    return <div className="app-wallpaper employee-wallpaper min-h-screen flex items-center justify-center text-slate-500">Loading...</div>;
  }
  ...
  return (
    <div className="app-wallpaper employee-wallpaper min-h-screen max-w-sm mx-auto flex flex-col px-5 py-6">
